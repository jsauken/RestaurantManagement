...
public class JwtProvider {
    ...
    public String generateAccessToken(@NonNull CustomerDTO customerDTO) {
        ...
        return Jwts.builder()
                ...
                .claim("Roles", customerDTO.getRoles())
                .signWith(jwtAccessSecret)
                .claim("Name", customerDTO.getName())
                .compact();
    }

    public String generateRefreshToken(@NonNull CustomerDTO customerDTO) {
        final LocalDateTime now = LocalDateTime.now();
